  ...
  switch (timeOfDay) {
    case 'sunset':
      return {
        ...
        sun: { color: 0xff6633, intensity: 1.5, position: [20, 30, 100] },
        hemi: { sky: 0xff8855, ground: 0x553322, intensity: 0.3 },
      }
    case 'night':
      return {
        sky: 0x0a0a1a,
        ...
        sun: { color: 0x6688aa, intensity: 0.3, position: [-50, 80, 50] },
        hemi: { sky: 0x112233, ground: 0x080808, intensity: 0.1 },
      }
    default: // day
      return {
        sky: 0x87ceeb,
        ...
        sun: { color: 0xffffff, intensity: 1.2, position: [100, 200, 100] },
        hemi: { sky: 0x87ceeb, ground: 0x3a3a2a, intensity: 0.3 },
      }
  }
}
...
function buildFlyover(data, scene) {
  ...
  // === DECK ===
  const deckGroup = createDeck(smoothPoints, width, 0.8)
  group.add(deckGroup)
  ...
  pillars.forEach(([lng, lat], i) => {
    ...
    const pillar = createPillar(height, 0.8, pillarMat)
